...
class Server(discord.Guild):
    ...
    class ServerSchema(Schema):
        ...
        xp_global_limit_expr = fields.String(allow_none=True, load_default=0)
        max_characters_expr = fields.String(allow_none=True, load_default=0)
        activity_char_count_threshold = fields.Integer(allow_none=True)
